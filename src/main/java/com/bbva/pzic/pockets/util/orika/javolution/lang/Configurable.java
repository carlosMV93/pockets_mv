 ...
 */
package com.bbva.pzic.pockets.util.orika.javolution.lang;

import java.io.InputStream;
import java.util.Enumeration;

import com.bbva.pzic.pockets.util.orika.javolution.context.LogContext;
import com.bbva.pzic.pockets.util.orika.javolution.context.SecurityContext;
...
import com.bbva.pzic.pockets.util.orika.javolution.util.FastTable;
import com.bbva.pzic.pockets.util.orika.javolution.xml.XMLBinding;
import com.bbva.pzic.pockets.util.orika.javolution.xml.XMLFormat;
import com.bbva.pzic.pockets.util.orika.javolution.xml.XMLObjectReader;
...
public class Configurable <T>  {
     ...
     * for {@link com.bbva.pzic.pockets.util.orika.javolution.context.ConcurrentContext#MAXIMUM_CONCURRENCY}.
     *
     ...
     * [/code] returns {@link com.bbva.pzic.pockets.util.orika.javolution.context.ConcurrentContext#MAXIMUM_CONCURRENCY}.
     *
     ...
     * {@link com.bbva.pzic.pockets.util.orika.javolution.text.TextFormat#getInstance(Class)}
     ...
     * performed using {@link com.bbva.pzic.pockets.util.orika.javolution.text.TextFormat#getInstance(Class)}.
     *
     * <p><b>Note:</b> OSGI based framework should ensure that class loaders
     *    of configurable instances are known to the {@link Reflection} utility
     *    class.</p>
