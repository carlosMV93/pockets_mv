...
public interface Converter<S, D> extends MappedTypePair<S, D> {
     ...
     * @param <D>
     */
    public static class LegacyConverter<S, D> implements com.bbva.pzic.pockets.util.orika.Converter<S, D> {
        
        private com.bbva.pzic.pockets.util.orika.converter.Converter<S, D> delegate;
        
        public LegacyConverter(com.bbva.pzic.pockets.util.orika.converter.Converter<S, D> delegate) {
