...
/**
 * Bean de respuesta para la transacci&oacute;n <code>BQ71</code>
 *
...
@Multiformato(formatos = {FormatoBGMQ711.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionBq71 implements MensajeMultiparte {
