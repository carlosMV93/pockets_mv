...
/**
 * Bean de respuesta para la transacci&oacute;n <code>BQ76</code>
 * 
...
@Multiformato(formatos = {FormatoBQM76S1.class })
@RooJavaBean
@RooSerializable
public class RespuestaTransaccionBq76 implements MensajeMultiparte {
