...
/**
 * Bean de respuesta para la transacci&oacute;n <code>BQ40</code>
 *
...
@Multiformato(formatos = {FormatoBQM40S1.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionBq40 implements MensajeMultiparte {
