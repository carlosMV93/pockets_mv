...
/**
 * Bean de respuesta para la transacci&oacute;n <code>BQ81</code>
 * 
...
@Multiformato(formatos = {FormatoBQM81S1.class })
@RooJavaBean
@RooSerializable
public class RespuestaTransaccionBq81 implements MensajeMultiparte {
