...
/**
 * Formato de datos <code>BQM81E1</code> de la transacci&oacute;n <code>BQ81</code>
 * 
 * @author Arquitectura Spring BBVA
 */
@Formato(nombre = "BQM81E1")
@RooJavaBean
@RooSerializable
public class FormatoBQM81E1 {
	 ...
	 */
	@Campo(indice = 2, nombre = "NOMCOR", tipo = TipoCampo.ALFANUMERICO, longitudMinima = 60, longitudMaxima = 60)
	...
	/**
	 * <p>Campo <code>PRIPOC</code>, &iacute;ndice: <code>6</code>, tipo: <code>ALFANUMERICO</code>
	 */
	@Campo(indice = 6, nombre = "PRIPOC", tipo = TipoCampo.ALFANUMERICO, longitudMinima = 3, longitudMaxima = 3)
	private String pripoc;
	
	/**
	 * <p>Campo <code>TIPPOC</code>, &iacute;ndice: <code>7</code>, tipo: <code>ALFANUMERICO</code>
	 */
	@Campo(indice = 7, nombre = "TIPPOC", tipo = TipoCampo.ALFANUMERICO, longitudMinima = 3, longitudMaxima = 3)
	private String tippoc;
	
	/**
	 * <p>Campo <code>FLAGPOC</code>, &iacute;ndice: <code>8</code>, tipo: <code>ALFANUMERICO</code>
	 */
	@Campo(indice = 8, nombre = "FLAGPOC", tipo = TipoCampo.ALFANUMERICO, longitudMinima = 1, longitudMaxima = 1)
	...
	/**
	 * <p>Campo <code>DIAAUTO</code>, &iacute;ndice: <code>12</code>, tipo: <code>ENTERO</code>
	 */
	@Campo(indice = 12, nombre = "DIAAUTO", tipo = TipoCampo.ENTERO, longitudMinima = 2, longitudMaxima = 2)
