...
/**
 * Bean de respuesta para la transacci&oacute;n <code>BQ72</code>
 *
...
@Multiformato(formatos = {FormatoBGMQ721.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionBq72 implements MensajeMultiparte {
