...
/**
 * Bean de respuesta para la transacci&oacute;n <code>BQ77</code>
 * 
...
@Multiformato(formatos = {FormatoBQM77S1.class })
@RooJavaBean
@RooSerializable
public class RespuestaTransaccionBq77 implements MensajeMultiparte {
