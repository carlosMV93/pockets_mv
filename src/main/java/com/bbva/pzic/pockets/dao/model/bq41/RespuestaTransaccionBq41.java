...
/**
 * Bean de respuesta para la transacci&oacute;n <code>BQ41</code>
 *
...
@Multiformato(formatos = {FormatoBQM41S1.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionBq41 implements MensajeMultiparte {
