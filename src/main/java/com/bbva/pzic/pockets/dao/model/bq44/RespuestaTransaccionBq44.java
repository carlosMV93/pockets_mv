...
/**
 * Bean de respuesta para la transacci&oacute;n <code>BQ44</code>
 *
...
@Multiformato(formatos = {FormatoBQM44P1.class, FormatoBQM44S1.class})
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionBq44 implements MensajeMultiparte {
